...
public class PostDetailActivity extends AppCompatActivity {
    ...
    private void detailInfo() {
        ...
        String titulo = "Titulo: " + getIntent().getStringExtra("titulo");
        binding.videojuego.setText(titulo);
        ...
        String duracion = "Duración del viaje: " + getIntent().getIntExtra("duracion", 0) + " días.";
